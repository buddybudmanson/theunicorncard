# The Unicorn Card Archive — Museum Edition v4 — Search Edition
...
## Museum Edition v4 — Search Edition
...
- JSON-LD structured data for WebSite, WebPage, Article, FAQPage, DefinedTerm, ImageObject and BreadcrumbList.
- New Definitions and Citation pages.
- Visible breadcrumb navigation.
- Expanded sitemap and llms.txt.
...
2. Add and verify `https://theunicorncard.com`.
3. Submit `https://theunicorncard.com/sitemap.xml`.
4. Request indexing for the homepage, Definitions, Identification, Story and Provenance pages.
5. Add the site to Bing Webmaster Tools and submit the same sitemap.

- Contact page removed from navigation and site package.
